            ...
            <div class="col-xl-3 col-lg-5 col-md-6 ">
                <div class="footer-widget mb-40">
                    <div class="footer-logo">
                        <a href="index.html"><img src="/assets_client/img/logo/footer-logo.png" alt=""></a>
                    </div>
                    ...
                    <div class="footer-time d-flex mt-30">
                        <div class="time-icon">
                            <img src="/assets_client/img/icon/time.png" alt="">
                        </div>
                        <div class="time-text">
            ...
            <div class="col-xl-3 col-lg-5 col-md-6">
                <div class="footer-widget mb-40">
                    <div class="footer-banner">
                        <a href="shop.html"><img src="/assets_client/img/anh1.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
